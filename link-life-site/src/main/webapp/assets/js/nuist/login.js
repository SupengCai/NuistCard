$(function() {
	...
	$("#btn-ranklist").click(function() {
		window.location.replace("ranklist");
	});

	$("#btn-cardlost").click(function() {
		window.location.replace("cardlost");
	});
	...
	$("#btn-signout").click(function() {
		window.location.replace("index?signout=1");
	});
			...
			.click(
					function() {
						if ($("#form-signin").valid()) {
							$(
									"#btn-recharge,#btn-info,#btn-changepwd,#btn-signin,#btn-sub-signin,#btn-history,#btn-ranklist")
									.unbind();
							$("#post-modal").show();
							$("#progressing").show();
