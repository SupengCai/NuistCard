...
public class TestJedis {
	...
	public void test(final Redisobj obj) {
		HashMapper<Redisobj, String, String> hashMapper = new DecoratingStringHashMapper<Redisobj>(
				new JacksonHashMapper<Redisobj>(Redisobj.class));
		java.util.Map<String, String> map = hashMapper.toHash(obj);
		redisTemplate.execute(new RedisCallback<Object>() {
			@Override
			public Object doInRedis(RedisConnection connection) throws DataAccessException {
				 byte[] key = redisTemplate.getStringSerializer().serialize("test");
