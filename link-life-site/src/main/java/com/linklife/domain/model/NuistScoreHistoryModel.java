...
public class NuistScoreHistoryModel extends NuistScoreHistory<NuistScoreHistory, NuistScoreHistoryExample> {

	public void insertScoreHistory( int accountId, double amount, String remoteAddr, String explorer ) {
